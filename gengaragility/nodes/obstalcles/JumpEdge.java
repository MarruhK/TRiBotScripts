...
public class JumpEdge extends Obstacle
{
    // Constants
    private static final RSTile TILE_SE = new RSTile(2702, 3460, 2);
    private static final RSTile TILE_NW = new RSTile(2698, 3465, 2);
    private static final RSArea AREA = new RSArea(TILE_NW, TILE_SE);

    private static final int ID_OBSTACLE = 11377;

    public JumpEdge(ACamera aCamera)
    {
        super(aCamera);
        averageWaitingTime = 3600;
    }
    ...
    public void execute()
    {
        ...
        System.out.println("The JumpEdge Node has been Validated! Executing...");
