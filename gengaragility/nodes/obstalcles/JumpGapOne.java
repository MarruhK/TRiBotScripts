...
public class JumpGapOne extends Obstacle
{
    // Constants
    private static final RSTile TILE_SE = new RSTile(2730, 3490, 3);
    private static final RSTile TILE_NW = new RSTile(2721, 3497, 3);
    private static final RSArea AREA = new RSArea(TILE_NW, TILE_SE);
    private static final int ID_OBSTACLE = 11374;

    public JumpGapOne(ACamera aCamera)
    {
        super(aCamera);
        averageWaitingTime = 6751;
    }
    ...
    public void execute()
    {
        ...
        System.out.println("The JumpGapOne Node has been Validated! Executing...");
