package scripts.gengaragility.utility;
...
public class Antiban
{
    ...
    // Allows to access antiban methods without instantiating scripts.gengarlibrary.Antiban within the script. It's all done within the class.
